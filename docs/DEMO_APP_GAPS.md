...
>   and [`TODO.md`](../TODO.md). The remaining gaps are the packaging/hosting
>   story (G7 — Dockerfile + Pages deploy) and optional polish (baking
>   thumbnails/labels into the *published* snapshot, and precomputed showcase
>   swipe/change/timescan artifacts for a handful of curated sites).
>
