...
foundation-model and change-detection research (the C4 workstream) -- the
audience most likely to contribute back and the one that turns free Umbra
pixels into demand for Umbra pixels.
